export const projects = [
  {
    ...
    name: "KittyChat",
    description:
      "A chat application built with socket.io, themed in a silly way for chatty cats.",
  ...
  },
  {
    id: 3,
    name: "Review app",
    description: "A review app built with Angular, Express and Bootstrap.",
  ...
  },
  {
    ...
    name: "Todo app",
    description:
      "Keep track of your todos with this app, built with React and styled with Tailwind.",
...

  {
    ...
    name: "Weather app",
    description:
      "Check out the weather by searching for cities all over the world, toggle the background between some nice cityscapes or current weather view. \r \n Made with the Weather API and Bootstrap",
    ...
    detailImage: [
      "/Weather/weather-laptop-mockup-rio.jpg",
      "/Weather/weather-phone-mockup-rio.jpg",
    ],
  },
  {
    id: 6,
    name: "Pokedex",
    description:
      "Search for a Pokemon by ID, number or get a random one, toggle a cool opening and closing effect. Built with JS, PHP and the Pokemon API",
