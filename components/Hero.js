...
const Hero = () => {
  return (
    <Parallax y={[-60, 65]}>
      <div className="hero relative -top-4 grid grid-cols-8 bg-white mx-6 md:mx-16 2xl:mx-40 my-16 xl:my-32">
        <h1 className="header-title relative leading-snug col-span-8 2xl:col-start-2 2xl:col-span-7 text-4xl md:text-5xl lg:text-6xl md:leading-snug 2xl:text-6xl lg:leading-snug 2xl:leading-snug">
